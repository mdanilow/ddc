...
HD_PWD='E:/rzeczy/vivado_projekty/klt_ddc/klt_ddc.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log tor_wizyjny_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tor_wizyjny_wrapper.tcl -notrace
